...
export const SERVICES = [
  ...
  },
  {
    ...
    title: "Branding",
    description:
      "Whether you're launching something new or redefining your existing business, we create a complete brand identity that reflects who you are and how you should be perceived. From idea to identity — we build brands that last.",
    icon: "FaPalette",
  },
];
